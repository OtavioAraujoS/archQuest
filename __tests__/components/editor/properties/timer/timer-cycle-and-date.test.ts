...
} from '@/components/editor/properties/timer/timer-cycle-and-date'

describe('cycleToIso and parseIsoCycle', () => {
  it('converts a limited cycle and back', () => {
    const cycle = {
      repetitions: 3,
      interval: { amount: 10, unit: 'minutes' as const },
    }
...
describe('localDateTimeToIso and parseIsoLocalDateTime', () => {
  it('converts the datetime-local value and back', () => {
    ...
    expect(parseIsoLocalDateTime('2026-10-01T09:30:00')).toBe(
      '2026-10-01T09:30',
    )
